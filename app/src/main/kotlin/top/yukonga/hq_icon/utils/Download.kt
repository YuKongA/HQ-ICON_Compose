...
class Download {
    suspend fun downloadImage(context: Context, url: String, fileName: String, resolution: String, corner: String) = withContext(Dispatchers.IO) {
    ...
    private suspend fun saveImageToStorage(context: Context, bitmap: Bitmap, filename: String) = withContext(Dispatchers.IO) {
        val values = ContentValues().apply {
            ...
            put(MediaStore.Images.Media.RELATIVE_PATH, "${Environment.DIRECTORY_PICTURES}/${context.getString(R.string.app_name)}")
        }
